    ...
    <>
      ...
      >
        <Container sx={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            Join Us in Making a <span style={{ color: '#ffbe01', fontSize: '3.2rem' }}>Difference</span>
          </Typography>
          ...
          >
            At VSoft Solutions, we're more than just a tech company - we're a team of innovators, creators, and problem-solvers who believe in using technology to make an impact.<br></br> Whether you're just starting your career or expanding your expertise, VSoft offers a dynamic environment for learning, collaboration, and growth.
          </Typography>
        </Container>
      </Box>
